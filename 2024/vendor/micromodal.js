/*
Patched version of Micromodal
to make it compatible with spectre js, it adds/remove the "active" CSS class
in addition to is-open when opening/closing a modal
*/
